...
class SignupPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    SignupPageController controller = Get.put(SignupPageController(context));
...
class SignupPageController extends BaseGetxController {
  ...
  SignupPageController(BuildContext context) : super(context) {
    _authenticationService = Get.find();
    firstNameController.addListener(textChanged);
    lastNameController.addListener(textChanged);
  ...
  textChanged() {
    isSignupEnabled.value = firstNameController.text.isNotEmpty &&
  ...
  onSignup(BuildContext context) async {
    ...
    var response = await _authenticationService.signup(request);
    isBusy.value = false;
    if (response != null) {
      Get.back();
      await showCustomGeneralDialog(
